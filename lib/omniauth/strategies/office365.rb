  ...
  module Strategies
    class Office365 < OmniAuth::Strategies::OAuth2
      ...
      option :client_options, {
        ...
        token_url:     'https://login.windows.net/415abcba-efe6-43bc-b3e7-1f1e9fb2dd3b/oauth2/token',
        authorize_url: 'https://login.windows.net/415abcba-efe6-43bc-b3e7-1f1e9fb2dd3b/oauth2/authorize'
      }
